import { View, Text, SafeAreaView, StyleSheet, Image, ScrollView, ImageBackground } from 'react-native'
    ...
    <SafeAreaView style={globallyStyle.safeAreaView}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ paddingHorizontal: 17 }}>
          ...
          <Height top={9} />
          <Text style={styles.title}>Sleep Overnight :__</Text>
          <Height top={9} />
